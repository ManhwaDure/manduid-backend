/*
  ...
  - Added the required column `graphQlSessionId` to the `oauth2AuthorizationCode` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `oauth2AuthorizationCode` ADD COLUMN     `graphQlSessionId` VARCHAR(191) NOT NULL;
