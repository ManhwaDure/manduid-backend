/*
  ...
  - You are about to drop the column `backchannelLogoutUri` on the `oauth2client` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `oauth2client` DROP COLUMN `backchannelLogoutUri`,
